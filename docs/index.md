...
-   :material-information-outline:{ .lg .middle } __Additional information__
    ...
    ??? licensing "Open-source license and contribution policy"
        ...
        This training material is developed and maintained by [BUGFri](https://www.unifr.ch/bio/en/groups/falquet/) and released under an open-source license ([CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/)) for the benefit of the community.
